...
public class GenEntityMysql {
    ...
    // TODO 需要修改的地方
    private static final String URL = "jdbc:mysql://dev01.drplt.com:3306/dp_baseinfo2";
    private static final String NAME = "pengbo";
    private static final String PASS = "123456";
    private static final String DRIVER = "com.mysql.jdbc.Driver";
    private String packageOutPath = "com.zeusas.cloud.buos.entity";// 指定实体生成所在包的路径
    private String authorName = "liull";// 作者名字
    ...
    private void generate() throws Exception {
        ...
        if (generateTables == null) {
            //从元数据中获取到所有的表名
            ResultSet rs = db.getTables(null, "dp_baseinfo2", "%", new String[] { "TABLE" });
